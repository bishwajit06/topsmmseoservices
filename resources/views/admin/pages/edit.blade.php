            ...
            <div class="row mt">
                <div class="col-lg-12">
                    ...
                    <div class="form-panel">
                        <div class=" form">
                            <form class="cmxform form-horizontal style-form" id="commentForm" action="{{route('admin.page.update',$page->id)}}" method="post" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                ...
                                <div class="form-group ">
                                    ...
                                    <div class="col-lg-8">
                                        <textarea class="form-control" id="tinymce" name="body" rows="5">{{$page->body}}</textarea>
                                    </div>
                                </div>

                                <div class="form-group">
                                    <label class="control-label col-md-2">Page Image Upload</label>
                                    <div class="col-md-10">
                                        <div class="row">
                                            @if ($page->image)
                                            <div class="col-md-2">
                                                <div class="fileupload fileupload-new" data-provides="fileupload">
                                                    <div class="fileupload-new thumbnail" style="width: 200px; height: 150px;">
                                                        <img style="width: 100%; height: 100%;" src="{{asset('storage/page/'.$page->image)}}" alt="" />
                                                    </div>
                                                ...
                                                <input type="file" class="default" name="image" value="{{$page->image}}"/>
                                                </span>
