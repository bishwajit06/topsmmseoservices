...
@section('content')
    <section id="main-content">
        <section class="wrapper">
            ...
            <div class="row mt">
                <div class="col-lg-12">
                    <h4><i class="fa fa-angle-right"></i> Add New Post</h4>
                    <div class="form-panel">
                        <div class=" form">
                            <form class="cmxform form-horizontal style-form" id="commentForm" action="{{route('author.post.store')}}" method="post" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="form-group ">
                                    ...
                                    <div class="col-lg-8">
                                        <textarea class="form-control" id="tinymce" name="body" rows="10">{{ old('body') }}</textarea>
                                    </div>
                                </div>
