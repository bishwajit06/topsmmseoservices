            ...
            <div class="row mt">
                <div class="col-md-12">
                    <div class="content-panel">
                        <h4><i class="fa fa-angle-right"></i> <a href="{{route('author.post.create')}}" type="button" class="btn btn-theme">Add Post</a></h4>
                        <div class="adv-table">
                            <table class="table table-striped table-advance table-hover" id="hidden-table-info">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a target="_blank" href="{{route('post.details',$post->slug)}}"><strong>{{$post->title}}</strong></a>
                                    </td>
                                    <td>{!!  substr(strip_tags($post->body), 0, 60) !!}</td>
                                    <td>{{ $post->view_count }}</td>

                                    <td>
                                        <a target="_blank" href="{{route('post.details',$post->slug)}}" class="btn btn-success btn-xs"><i class="fa fa-check"></i></a>
                                        <a href="{{route('author.post.edit',$post->id)}}" class="btn btn-primary btn-xs"><i class="fa fa-pencil"></i></a>
